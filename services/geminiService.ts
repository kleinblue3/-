...
// 核心修改：板块6强制要求引用行业头部真实案例，若无精准竞品则分析赛道巨头，严禁杜撰
...

{
  ...
  "founderExperience": "创始人0-1落地经验：【严禁杜撰】必须引用真实存在、可被百度/小红书搜索到的行业标杆或知名网红品牌！若无完全匹配的细分竞品，请分析该大赛道的头部品牌（如瑞幸、喜茶、霸王茶姬或具体百万粉博主）。格式：先写【对标案例：品牌名】，再分析其早期低成本起盘或获客的真实策略。",
    ...
    const requestBody = {
      ...
      messages: [
        ...
        { 
            role: "user", 
            // 再次强调完整性和真实性
            content: `请分析这个商业创意：${idea}。\n\n务必输出完整的JSON，包含所有7个板块。在分析“创始人经验”时，请务必引用真实可查的行业头部案例或知名博主，禁止编造假品牌。` 
        }
      ]
    };
